...
<form id="updateForm" action="/admin-page/update-language" method="post">

    <input name="id" type="number" placeholder="Id" value="${requestScope.language.id}">
    <br>
    <input name="name" type="text" placeholder="language name" value="${requestScope.language.name}">
    <br>
